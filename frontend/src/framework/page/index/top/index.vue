<template>
  <div class="avue-top">
    ...
    <div class="top-bar__right">
      ...
      <img class="top-bar__img" :src="user.avatar" />
      <el-dropdown>
...
<script>
import { resetRouter } from "@/framework/router/router";
import { mapGetters, mapState } from "vuex";
import { fullscreenToggel, listenfullscreen } from "@/framework/util/util";
...
export default {
  ...
  data() {
    return {
      user: window.GFActor.user,
    };
  },
  filters: {},
  created() {
    window.GF.emitter.emit("WebSocket");
  },
  mounted() {
